...
Route::middleware(['auth:user'])->group(function (){
    ...
    Route::post('/konfigurasi/{kode_jamkerja}/update', [KonfigurasiController::class, 'update']);
    Route::post('/konfigurasi/{kode_jamkerja}/delete', [KonfigurasiController::class, 'delete']);
