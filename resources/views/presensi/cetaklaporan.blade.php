            ...
            <tr>
                <td rowspan="6">
                    ...
                    @if ($karyawan->foto != null)
                        <img src="{{ url($path) }}" alt="" width="125px" height="135px">
                    @else
                        <img src="{{ asset('assets/img/nophoto.jpg') }}" alt="" width="140px" height="150px">
                    @endif
                </td>
            </tr>
            <tr>
        ...
        <table class="tabelpresensi">
            ...
            @foreach ($presensi as $d)
                ...
                <tr>
                    ...
                    <td style="text-align: center">{{ date('H:i', strtotime($d->jam_in)) }}</td>
                    <td style="text-align: center">
                        <img src="{{ url($path_in) }}" alt="" class="foto">
                    </td>
                    <td style="text-align: center">
                        {{ $d->jam_out != null ? date('H:i', strtotime($d->jam_out)) : 'Belum Absen' }}</td>
                    <td style="text-align: center">
                        @if ($d->jam_out != null)
